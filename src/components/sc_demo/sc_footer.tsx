  ...
  return (
    <footer className='bg-white'>
      <div className='bg-primary py-16'>
        <div className='mx-auto max-w-2xl bg-primary text-center'>
          ...
          <div className='mt-8 flex justify-center'>
            <a
              href='#'
              className='rounded-md bg-secondary px-3.5 py-2.5 text-sm font-semibold text-white  hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400'
            >
              Get started
            </a>
          </div>
      ...
      <div className='mx-auto max-w-7xl px-6 py-16 sm:pb-24 lg:px-8 lg:pb-32 '>
