  ...
  <div className="ml-3 font-bold">{SC_CONFIG.SITE_TITLE}</div>
            ...
            <div className='flex gap-x-6'>
              <a href='#' className='text-gray-600 hover:text-gray-800'>
                ...
                <svg fill='currentColor' viewBox='0 0 24 24' className='size-6' aria-hidden='true'>
                  <path
                    fillRule='evenodd'
        ...
        <div className='mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24'>
          <p className='text-sm/6 text-gray-600'>&copy; {SC_CONFIG.SITE_TITLE}{" "}{new Date().getFullYear()}, All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
