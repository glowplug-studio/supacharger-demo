      ...
      <div className='-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:shrink-0'>
        <div className='rounded-md bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16'>
          <div className='mx-auto max-w-xs px-8'>
            <p className='text-base font-semibold text-gray-600'>Unlimited access, forever</p>
            <p className='mt-6 flex items-baseline justify-center gap-x-2'>
              <span className='text-5xl font-semibold tracking-tight text-gray-900'>$500</span>
