...
export default function SignUp() {
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center items-center h-screen bg-sc-gradient">
        <div className="w-full md:w-1/3 p-6">
          <div className="sm:mx-auto sm:w-full sm:max-w-[380px]">
            <div className="">
              ...
              <h2 className="my-6 text-2xl/9 font-bold tracking-tight text-gray-900">
                Create an Account
              </h2>

              <Link href="/signin" className='text-'>Sign In</Link>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                      autoComplete="email"
                      className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus"
                      value={email}
                ...
                <div>
                  <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-primary px-3 py-1.5  font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Create
                  </button>
