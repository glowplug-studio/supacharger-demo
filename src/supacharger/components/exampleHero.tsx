    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <h1 className="mt-10 text-5xl font-semibold tracking-tight text-white sm:text-7xl">
              Don&apos;t Reinvent the wheel. <br/>Roll with it.
            </h1>
     ...
     <div className="bg-gray-50 py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <p className="mx-auto mt-2 max-w-lg text-center text-3xl font-semibold tracking-tight text-balance text-gray-950 sm:text-5xl">
